...
* **[app.s](app.s)** Este archivo contiene a aplicación. Todo el hardware ya está inicializado anteriormente.
* **[start.s](start.s)** Este archivo realiza la inicialización del hardware.
* **[draw_functions.s](draw_functions.s)** Este archivo contiene las funciones que serviran de ayuda para dibujar en la pantalla.
